      ...
      <div className="w-full max-w-[1600px] mx-auto px-6 py-20 md:py-32 relative z-30">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-10">
          ...
          <div className="flex flex-row lg:flex-col gap-8 lg:w-[60px] items-center justify-center w-full lg:w-auto mt-8 lg:mt-0">
             <a href="https://www.instagram.com/svkscales?igsh=MTkzZjkzOHNkNHExbg%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-[#C41A1A] hover:text-white transition-colors">
             ...
             <a href="https://www.facebook.com/?locale=en_GB" target="_blank" rel="noopener noreferrer" className="text-[#C41A1A] hover:text-white transition-colors">
             ...
             <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" className="text-[#C41A1A] hover:text-white transition-colors">
